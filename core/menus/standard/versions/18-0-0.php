...
function getMenusOfLeft($db, $mainmenu, &$menu, &$tabMenu, $leftmenu, $substitarray, $usemenuhider, $type_user = 0){
	...
	if ($mainmenu) {	// If this is empty, loading hard coded menu and loading personalised menu will fail
		...
		*/
		...
		$newmenu = $menuArbo->menuLeftCharger($newmenu, $mainmenu, $leftmenu, (empty($user->socid) ? 0 : 1), 'revolutionpro', $tabMenu);
		//var_dump($newmenu->liste);    //
